...
**Tracked total:** 37 / **$20,320.22** | **Candidates:** 1 / **$30**

### 🟢 Candidates (CANDIDATE + CAUTION, by reward)

- **$30** — [[BOUNTY] RCS Support [14999$]](https://github.com/microg/GmsCore/issues/2994) *(microg)* `Java` ⚠️CAUTION
...
- ⚠️CAUTION (0att/2pr) **$30** — [[BOUNTY] RCS Support [14999$]](https://github.com/microg/GmsCore/issues/2994) *(microg)*
...
- 🔴AVOID (0att/2pr) **$40** — [Implement ST7789 parallel protocol in PIO](https://github.com/tinygo-org/pio/issues/38) *(tinygo-org)*
